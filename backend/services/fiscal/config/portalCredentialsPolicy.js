...
// Credential resolution for all fiscal portals.
// Pure functions — no side effects, no browser.
...
module.exports = {
    cleanText, foldText, onlyDigits,
    isUsableStatus, isAtCredential, isSegSocialCredential,
    isSegSocialSubUserCredential, isSegSocialPrincipalCredential,
    isIapmeiCredential, isViaCttCredential,
    resolveAtCredential, resolveSegSocialPrincipalCredential, resolveSegSocialSubUserCredential,
    resolveIapmeiCredential, resolveViaCttCredential, resolvePortalCredential,
