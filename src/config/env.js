...
function loadEnvConfig() {
    const config = {
        ...
        AGENDA_EMAIL_ENABLED: toBool(process.env.AGENDA_EMAIL_ENABLED, false),
        AGENDA_EMAIL_HOST: trim(process.env.AGENDA_EMAIL_HOST || process.env.IMAP_HOST || process.env.SMTP_HOST || 'mail.mpr.pt'),
        AGENDA_EMAIL_PORT: toInt(process.env.AGENDA_EMAIL_PORT || process.env.IMAP_PORT, 993),
        AGENDA_EMAIL_USERNAME: trim(process.env.AGENDA_EMAIL_USERNAME, 'agenda@mpr.pt'),
        AGENDA_EMAIL_PASSWORD: trim(process.env.AGENDA_EMAIL_PASSWORD),
        AGENDA_EMAIL_MAILBOX: trim(process.env.AGENDA_EMAIL_MAILBOX, 'INBOX'),
        AGENDA_EMAIL_SINCE_DAYS: Math.max(1, toInt(process.env.AGENDA_EMAIL_SINCE_DAYS, 14)),
        AGENDA_EMAIL_MAX_MESSAGES: Math.max(1, toInt(process.env.AGENDA_EMAIL_MAX_MESSAGES, 50)),
        AGENDA_EMAIL_POLL_INTERVAL_MINUTES: Math.max(1, toInt(process.env.AGENDA_EMAIL_POLL_INTERVAL_MINUTES, 5)),
        AGENDA_EMAIL_DEFAULT_USER_EMAIL: trim(process.env.AGENDA_EMAIL_DEFAULT_USER_EMAIL || process.env.SUPABASE_PEDIDOS_MANAGER_EMAIL || 'mpr@mpr.pt').toLowerCase(),
        AGENDA_SMTP_HOST: trim(process.env.AGENDA_SMTP_HOST || process.env.SMTP_HOST),
        AGENDA_SMTP_PORT: toInt(process.env.AGENDA_SMTP_PORT || process.env.SMTP_PORT, 465),
        AGENDA_SMTP_TLS: toBool(process.env.AGENDA_SMTP_TLS, toInt(process.env.AGENDA_SMTP_PORT || process.env.SMTP_PORT, 465) === 465),
        AGENDA_SMTP_USERNAME: trim(process.env.AGENDA_SMTP_USERNAME || process.env.AGENDA_EMAIL_USERNAME),
        AGENDA_SMTP_PASSWORD: trim(process.env.AGENDA_SMTP_PASSWORD || process.env.AGENDA_EMAIL_PASSWORD),
        AGENDA_SMTP_FROM_EMAIL: trim(process.env.AGENDA_SMTP_FROM_EMAIL || process.env.AGENDA_SMTP_USERNAME || process.env.AGENDA_EMAIL_USERNAME),
        AGENDA_SMTP_FROM_NAME: trim(process.env.AGENDA_SMTP_FROM_NAME, 'Agenda MPR'),
