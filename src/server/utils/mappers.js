function createMappers(deps) {
    ...
    function buildCustomerProfileFromInput(input, existingRawValue) {
        ...
        return {
            ...
            dataNascimento: pick('dataNascimento', ['data_nascimento', 'nascimento', 'birth_date', 'date_of_birth']),
            inicioAtividade: pick('inicioAtividade', ['inicio_atividade']),
            caePrincipal: pick('caePrincipal', ['cae_principal']),
            caeDescricao: pick('caeDescricao', ['cae_descricao']),
            caeSecundarios: pick('caeSecundarios', ['cae_secundarios', 'cae_secundario']),
            infoAtividades: pick('infoAtividades', ['info_atividades', 'atividades_exercidas']),
            codigoReparticaoFinancas: pick('codigoReparticaoFinancas', ['codigo_reparticao_financas']),
            codigoPostal: pick('codigoPostal', ['codigo_postal', 'cod_postal', 'cp']),
